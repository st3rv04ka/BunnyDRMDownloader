...
class BunnyVideoDRM:
    ...
    user_agent = {
        ...
        'sec-ch-ua-platform':
            '"Linux"',
        'user-agent':
            'Mozilla/5.0 (Macintosh; Intel Mac OS X; rv:122.0) Gecko/20101101 Firefox/122.0'
    }
    ...
    def prepare_dl(self) -> str:
        ...
        def main_playlist():
            ...
            if not resolutions:
                ...
                return resolutions[2]  # highest resolution, -1 for lowest
    ...
    def download(self):
        ...
        file_path = os.path.join("/home/bbb/Videos/Bunny CDN", self.file_name)
